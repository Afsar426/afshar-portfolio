        ...
        >
          <div>
            ...
            <p style={{ marginTop: 10, fontSize: 15, color: "#475569" }}>
              1st Year B.Tech — Artificial Intelligence | SAGE University, Indore
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#64748B" }}>
              📍 Indore, India
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#64748B" }}>
              ✉️ afsuuai@gmail.com | 📞 +91 9876543210
            </p>
          </div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            ...
            <li style={{ marginTop: 8 }}>
              <strong>12th Board — [School Name]</strong> (Board, Year) <br />
              <span style={{ color: "#64748B" }}>Percentage: [XX%]</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>10th Board — [School Name]</strong> (Board, Year)
              <br />
              <span style={{ color: "#64748B" }}>Percentage: [XX%]</span>
            </li>
          </ul>
